...
{#if isOpen}
	...
	>
		<!-- Modal Content -->
		<div class="bg-white dark:bg-gray-800 rounded-2xl shadow-xl max-w-md w-full will-change-transform transform-gpu transition-all duration-300 scale-100">
			<!-- Modal Header -->
			<div class="px-6 py-4 border-b border-gray-200 dark:border-gray-700 flex items-center justify-between">
				<h2 id="modal-title" class="text-xl font-bold text-gray-900 dark:text-white dark:text-white font-display">Android Beta Access</h2>
				<button 
					onclick={close}
					class="text-gray-400 dark:text-gray-500 hover:text-gray-600 dark:hover:text-gray-300 dark:text-gray-300 transition-colors"
			...
			<div class="px-6 py-6">
				{#if submitted}
					...
					<div class="text-center">
						...
						<h3 class="text-lg font-semibold text-gray-900 dark:text-white mb-2">Thanks for your interest!</h3>
				...
				{:else}
					...
					<div class="text-center mb-6">
						<div class="w-16 h-16 bg-teal-100 dark:bg-teal-900 rounded-full flex items-center justify-center mx-auto mb-4">
							<svg class="w-8 h-8 text-teal-600 dark:text-white" fill="currentColor" viewBox="0 0 284 284">
						...
						<h3 class="text-lg font-semibold text-gray-900 dark:text-white mb-2">Get early access</h3>
					...
					<form onsubmit={handleSubmit}>
						<div class="mb-4">
							...
							<input 
								...
								class="w-full px-4 py-3 border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white rounded-lg focus:ring-2 focus:ring-teal-500 focus:border-transparent outline-hidden transition-all"
								required
						...
						<div class="flex gap-3">
							<button 
								type="button"
								onclick={close}
								class="flex-1 px-4 py-3 border border-gray-300 dark:border-gray-600 text-gray-700 dark:text-gray-300 rounded-lg font-semibold hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors"
								disabled={isSubmitting}
							>
								Cancel
							</button>
